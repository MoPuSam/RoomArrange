						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<%-- <s:iterator var="u" value="#request.userList" status="status"> --%>
									<c:forEach items="${userList}" var="u" varStatus="vs"> 
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<a href="${ pageContext.request.contextPath }/adminUserServlet?method=edit&uid=${u.uid }">
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<a href="${ pageContext.request.contextPath }/adminUserServlet?method=delete&uid=${u.uid }">
